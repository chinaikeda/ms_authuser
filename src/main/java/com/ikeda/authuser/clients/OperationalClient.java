...
//    @Retry(name = "retryInstance", fallbackMethod = "retryfallback")
    ...
    public Page<UserRecordDto> getOperationalOneUser(UUID userId, Pageable pageable, String token){
        String url = baseUrlOperational + "/users?userId=" + userId;
    ...
    @CircuitBreaker(name = "circuitbreakerInstance", fallbackMethod = "circuitbreakerfallback")
    public Page<UserRecordDto> getOperationalAllUsers(Pageable pageable, String token){
        String url = baseUrlOperational + "/users";
        logger.debug("Request URL: {} ", url);
